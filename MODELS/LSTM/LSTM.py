...
class LSTM(nn.Module):
    ...
    def forward(self, x):
        ...
        # Flatten for LSTM, keeping the sequence length
        ...
        c0 = torch.zeros(self.num_layers, batch_size * self.num_nodes, self.hidden_dim).to(self.device)

        out, _ = self.lstm(x, (h0, c0))  # out: (batch_size * num_nodes, lookback, hidden_dim)
